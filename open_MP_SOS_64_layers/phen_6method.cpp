                  ...
                  *Date3, double *Date4, double *Date5, double *Date6)
{
  ...
  for (k = 0; k < 493; k++) {
    ...
    tmp2 = work;
    work = TMEP_tmp[ixLead];
    TMEP[iyLead] = TMEP_tmp[ixLead] - tmp2;
    ixLead++;
    iyLead++;
  }
  ...
  //  get DOY
  *Date1 = ((static_cast<double>(iindx) + 2.0) - 1.0) + -64.0;
  *Date2 = ((static_cast<double>(b_iindx) + 2.0) - 1.0) + -64.0;
  *Date3 = ((static_cast<double>(c_iindx) + 2.0) - 1.0) + -64.0;
  *Date4 = (static_cast<double>(idx) - 1.0) + -64.0;
  *Date5 = ((static_cast<double>(i) + 2.0) - 1.0) + -64.0;
  *Date6 = ((static_cast<double>(ixLead) + 2.0) - 1.0) + -64.0;
}
